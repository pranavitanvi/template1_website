document.addEventListener('DOMContentLoaded', () => {
    ...
    // Extract category from data-attribute or URL
    const pathname = window.location.pathname.toLowerCase();
    let currentCategory = (shopGrid && shopGrid.dataset.category) ? shopGrid.dataset.category : 'all';
    if (currentCategory === 'all') {
        if(pathname.includes('chains')) currentCategory = 'chains';
        else if(pathname.includes('rings')) currentCategory = 'rings';
        else if(pathname.includes('earrings')) currentCategory = 'earrings';
        else if(pathname.includes('bracelets')) currentCategory = 'bracelets';
        else if(pathname.includes('bangles')) currentCategory = 'bangles';
        else if(pathname.includes('pendants')) currentCategory = 'pendants';
        else if(pathname.includes('mangalsutras') || pathname.includes('mangalsutra')) currentCategory = 'mangalsutra';
        else if(pathname.includes('mens')) currentCategory = 'mens';
    }
