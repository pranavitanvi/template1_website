...
@section('title', 'Shop Luxury Jewellery | Aura Fine Jewellery')
@section('meta_description', 'Explore our complete catalogue of fine rings, necklaces, earrings, bracelets, and bridal jewellery.')
@section('main_style', 'margin-top: 140px;')

@section('content')
<div class="container">
    <!-- Breadcrumb -->
    <div class="breadcrumb" style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 2rem;">
        <a href="{{ route('home') }}" style="color: var(--text-primary); text-decoration: none;">Home</a> / <span style="color: var(--text-secondary);">Shop</span>
    </div>
