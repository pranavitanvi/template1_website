        ...
        <div class="cont-grid">
            <div class="cont-form-wrap">
                ...
                <form id="storeContactForm" method="POST">
                    ...
                    <div class="cont-form-group" style="text-align: left; margin-top: 1.5rem; margin-bottom: 2rem;">
                        ...
                        <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                            ...
                            <input type="text" name="captcha" id="contactCaptcha" class="cont-input" placeholder="Enter Captcha" required maxlength="6" autocomplete="off"
                                   style="flex: 1; min-width: 140px; height: 46px; margin: 0; padding: 0 0.75rem; letter-spacing: 0.1em; font-weight: 600; font-size: 0.88rem; text-transform: uppercase;">
                        </div>
                    </div>
...
function refreshContactCaptcha() {
    var img = document.getElementById('contactCaptchaImg');
    var icon = document.getElementById('contactRefreshIcon');
    if (icon) {
